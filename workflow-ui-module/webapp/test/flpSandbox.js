		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpaauditworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpaauditworkflowuimodule-display": {
								"semanticObject": "bpaauditworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpaaudit.workflowuimodule",
									"url": sap.ui.require.toUrl("bpaaudit/workflowuimodule")
								}
							}
						}
					}
